<?php
  ...
  $products = [
    new Food('https://shop-cdn-m.mediazs.com/bilder/natural/trainer/sterilised/con/carni/bianche/1/400/97653_pla_naturaltrainer_sterilised_white_meat_cat_10kg_1.jpg', 'Gatti', 'Natural trainer', '56,99', 'Salmone.'),
    ...
    new Bed('https://shop-cdn-m.mediazs.com/bilder/cuccia/per/cani/spike/classic/9/800/60837_spike_classic_outside_fg_9141_9.jpg', 'Cani', 'Spike Classic', '106,99', 'Cuccia per cani Spike Classic, in legno di cipresso di Cunningham oleato, con tetto in cartone bitumato a spioventi. Piedini regolabili in altezza, ideale in caso di pioggia. (Il cane non è incluso).'),
